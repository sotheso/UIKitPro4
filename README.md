این یک بازی کوجک کلمات هست، به طوری که یک کلمه انگلیسی در بالای صفحه نمایش داده شده و کاربر باید از حروف آن کلمه کلمات معنی دار، درست و جدید غیر تکراری به لیست اضافه کند.
